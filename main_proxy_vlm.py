...
# 采用代理的方式调用Gemini API
def proxy_vlm_options(model: str, prompt: str):
    options = ApiVlmOptions(
        url="https://llm.judyplan.com/v1/chat/completions",  # 
        params=dict(
            model=model,
        ),
...
def main():  
    input_doc = Path("./test3/2025-05-20.pdf")  
    output_path = "./output/gemini-2.5-pro.md"  # 修改为你希望保存的路径  
    ...
    pipeline_options.vlm_options = proxy_vlm_options(
